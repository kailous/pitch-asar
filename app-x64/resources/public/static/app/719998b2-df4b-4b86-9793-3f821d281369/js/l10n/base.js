...
(function (root, G) {
  ...
  "versioning-overlay--footer-info--restore-back-to--label": function(d) { return "Select a slide to restore back to"; },
  ...
  "convert-template-dialog--heading": function(d) { return "Save as template"; },
  "convert-template-dialog--description": function(d) { return "The original presentation will stay as is"; },
  "convert-template-dialog--button--label": function(d) { return "Save as template"; },
  ...
  "template-picker--workspace-tab-title": function(d) { return "Team templates"; },
  ...
  "dashboard--sidebar--templates": function(d) { return "Team templates"; },
  "dashboard--sidebar--library": function(d) { return "Team library"; },
  "dashboard--sidebar--library-templates": function(d) { return "Templates"; },
  ...
  "dashboard--presentation-card--context-menu--save-as-template": function(d) { return "Save as template"; },
  ...
  "library--asset-manager-button--save": function(d) { return "Save"; },
  ...
  "quick-menu--insert-slide--label": function(d) { return "New slide"; },
  ...
  "quick-menu--guest-dashboard--empty-text": function(d) { return "Try: \"Open presentation\""; },
  "quick-menu--shared-space--empty-text": function(d) { return "Try: \"Open presentation\""; },
  "quick-menu--shared-folder--empty-text": function(d) { return "Try: \"Open presentation\""; },
  ...
  "quick-menu--sub-slide-status--label": function(d) { return "Set slide status"; },
  ...
  "quick-menu--toggle-version-history--label": function(d) { return "Version history"; },
  "quick-menu--toggle-deleted-slides--label": function(d) { return "Deleted slides"; },
  ...
  "platform--template-details--share": function(d) { return "Share"; },
  ...
  "platform--navbar--templates--label": function(d) { return "Templates"; },
  ...
  "platform--footer--product--item-2": function(d) { return "Templates"; },
  ...
  "integration-google-analytics-7-days-ago": function(d) { return "7 days ago"; },
  "integration-google-analytics-14-days-ago": function(d) { return "14 days ago"; },
  "integration-google-analytics-30-days-ago": function(d) { return "30 days ago"; },
  ...
  "player--pills-label-edit": function(d) { return "Edit"; },
  ...
  "player--pills-education-learn-more": function(d) { return "Learn more"; },
  ...
  "common--font-manager--editor-label-column": function(d) { return "Name"; },
  ...
  "common-inline-editor--panel-item--background-color-label": function(d) { return "Background color"; },
  "common-inline-editor--panel-item--background-image-label": function(d) { return "Image"; },
  "common-inline-editor--panel-item--templates-label": function(d) { return "Templates"; },
  ...
  "common--importer--learn-more": function(d) { return "Learn more"; },
  ...
  "magic-bell--delete": function(d) { return "Delete"; },
  "magic-bell--empty-state-title": function(d) { return "You’re all caught up!"; },
  "magic-bell--empty-state-text": function(d) { return "Your notifications will appear here."; },
  "magic-bell--accept-invite": function(d) { return "Accept invite"; },
  "slide-picker--heading--gallery": function(d) { return "Gallery templates"; },
  "slide-picker--heading--workspace": function(d) { return "Team templates"; },
  ...
  "slide-picker--add-all-slides--button-text": function(d) { return "Add all " + d.count + " slides"; },
  "slide-picker--browse--button-text": function(d) { return "Maximize"; },
  "slide-picker--compact--button-text": function(d) { return "Compact"; },
  ...
  "account--settings-index-notifications-setting-title": function(d) { return "Notifications"; },
  ...
  "editor--three-line-popup--save-as-template": function(d) { return "Save as template"; },
  ...
  "editor--three-line-popup--export-pdf": function(d) { return "Export as PDF"; },
  ...
  "editor--block-context-menu--align-center": function(d) { return "Center"; },
  ...
  "editor--block--image-display-name": function(d) { return "Image and media"; },
  ...
  "editor--chart-popover--csv-import-button-text": function(d) { return "Import a CSV"; },
  ...
  "editor--chart-popover--google-sheets-text": function(d) { return "Connect your Google Sheets account to import data directly into Pitch."; },
  ...
  "editor--chart-popover--suggest-integration-link-label": function(d) { return "Suggest integration"; },
  ...
  "editor--style-switcher--heading--presentation-styles": function(d) { return "Presentation styles"; },
  ...
  "editor--sidebar--add-slide-button": function(d) { return "New slide"; },
  ...
  "editor--vimeo-info": function(d) { return "Embed any Vimeo video into your presentation."; },
  "editor--shape-picker--shape-styles": function(d) { return "Shape styles"; },
  ...
  "editor--media-picker--brandfetch-legal-title": function(d) { return "Trademark and Copyright restrictions"; },
  "editor--media-picker--brandfetch-legal-summary": function(d) { return "The items may be subject to trademark or copyright restrictions."; },
  "editor--media-picker--brandfetch-legal-copy": function(d) { return "Most brands and logos are protected by trademark and copyright law. This does however not mean that such brands or logos may never be used in presentations. Rather, this depends, among other things, on the intended use of your presentation and the context of the use of the brand. In general, the following applies:"; },
  "editor--media-picker--brandfetch-legal-whats-ok": function(d) { return "• What is ok? You may use the brands/logos in a purely descriptive context to refer to other companies or to cite their goods/services as examples in your presentation."; },
  "editor--media-picker--brandfetch-legal-whats-not-ok": function(d) { return "• What is not ok? You may not use the brands/logos in such a way as to falsely create the impression that you have a business relationship with the other company or the goods/services."; },
  "editor--media-picker--brandfetch-legal-conclusion": function(d) { return "In cases of doubt, please consult a lawyer."; },
  "editor--media-picker--video-uploads--pro-incentive": function(d) { return "Upload videos with"; },
  ...
  "editor--media-picker--upload-image": function(d) { return "Upload image"; },
  ...
  "editor--text-options--heading--text-color": function(d) { return "Text color"; },
  "editor--text-options--heading--color": function(d) { return "Color"; },
  ...
  "editor--style-builder--shape-stroke-color-label": function(d) { return "Stroke color"; },
  ...
  "editor--style-builder--letter-spacing-label": function(d) { return "Letter spacing"; },
  "editor--style-builder--header-text-color-label": function(d) { return "Header text color"; },
  "editor--style-builder--border-color-label": function(d) { return "Stroke color"; },
  ...
  "editor--style-builder--line-spacing-label": function(d) { return "Line spacing"; },
  ...
  "editor--popover-headline-custom-color": function(d) { return "Custom color"; },
  "editor--popover-headline-style-colors": function(d) { return "Style colors"; },
  "editor--popover-headline-other-colors": function(d) { return "Other colors"; },
  ...
  "billing--upsell-tooltip--upgrade": function(d) { return "Upgrade"; },
  ...
  "billing--upsell--pdf-export--headline": function(d) { return "Upgrade for unbranded PDFs"; },
  "billing--upsell--pdf-export--headline--app-store": function(d) { return "Branded PDFs"; },
  "billing--upsell--pdf-export--content": function(d) { return "Your PDF will contain a tiny Pitch logo to help us spread the word. If you prefer to keep Pitch a secret, upgrade to Pitch Pro — and the logo will be gone."; },
  ...
  "shortcuts--basic--toggle--option--panel": function(d) { return "Toggle panel"; },
  ...
  "inspector--block-options--table--font-family": function(d) { return "Font family"; },
  ...
  "inspector--chart-options--font-family": function(d) { return "Font family"; },
  "inspector--chart-options--font-style": function(d) { return "Font style"; },
  "inspector--chart-options--font-size": function(d) { return "Font size"; },
  ...
  "inspector--shape-options--border-color": function(d) { return "Stroke color"; },
  ...
  "title-bar--folder-templates": function(d) { return "Team templates"; },
